...
public class InvestmentRecord extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1243826945694005565L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"InvestmentRecord\",\"namespace\":\"inc.evil.kafka.streams.avro.cpt\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"},{\"name\":\"symbol\",\"type\":\"string\"},{\"name\":\"amountBought\",\"type\":\"string\"},{\"name\":\"spent\",\"type\":\"string\"},{\"name\":\"unitPrice\",\"type\":\"string\"},{\"name\":\"investmentDate\",\"type\":\"string\"},{\"name\":\"investmentId\",\"type\":\"long\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<InvestmentRecord> ENCODER =
      new BinaryMessageEncoder<InvestmentRecord>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<InvestmentRecord> DECODER =
      new BinaryMessageDecoder<InvestmentRecord>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<InvestmentRecord> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<InvestmentRecord> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<InvestmentRecord> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<InvestmentRecord>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this InvestmentRecord to a ByteBuffer.
  ...
  /**
   * Deserializes a InvestmentRecord from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a InvestmentRecord instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static InvestmentRecord fromByteBuffer(
   ...
   */
  public InvestmentRecord(java.lang.Long id, java.lang.CharSequence symbol, java.lang.CharSequence amountBought, java.lang.CharSequence spent, java.lang.CharSequence unitPrice, java.lang.CharSequence investmentDate, java.lang.Long investmentId) {
    this.id = id;
    this.symbol = symbol;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: investmentId = (java.lang.Long)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   * @param value the value to set.
   */
  public void setInvestmentId(long value) {
    this.investmentId = value;
  }

  /**
   * Creates a new InvestmentRecord RecordBuilder.
   * @return A new InvestmentRecord RecordBuilder
   */
  public static inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder newBuilder() {
    return new inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder();
  }

  /**
   * Creates a new InvestmentRecord RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new InvestmentRecord RecordBuilder
   */
  public static inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder newBuilder(inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder other) {
    if (other == null) {
      return new inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder();
    } else {
      return new inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder(other);
    }
  }

  /**
   * Creates a new InvestmentRecord RecordBuilder by copying an existing InvestmentRecord instance.
   * @param other The existing instance to copy.
   * @return A new InvestmentRecord RecordBuilder
   */
  public static inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder newBuilder(inc.evil.kafka.streams.avro.cpt.InvestmentRecord other) {
    if (other == null) {
      return new inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder();
    } else {
      return new inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder(other);
  ...
  /**
   * RecordBuilder for InvestmentRecord instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InvestmentRecord>
    implements org.apache.avro.data.RecordBuilder<InvestmentRecord> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder other) {
      super(other);
      ...
      if (isValidValue(fields()[6], other.investmentId)) {
        this.investmentId = data().deepCopy(fields()[6].schema(), other.investmentId);
        fieldSetFlags()[6] = other.fieldSetFlags()[6];
      }
    }

    /**
     * Creates a Builder by copying an existing InvestmentRecord instance
     * @param other The existing instance to copy.
     */
    private Builder(inc.evil.kafka.streams.avro.cpt.InvestmentRecord other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder setSymbol(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder clearSymbol() {
      symbol = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder setAmountBought(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder clearAmountBought() {
      amountBought = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder setSpent(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder clearSpent() {
      spent = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder setUnitPrice(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder clearUnitPrice() {
      unitPrice = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder setInvestmentDate(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder clearInvestmentDate() {
      investmentDate = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder setInvestmentId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public inc.evil.kafka.streams.avro.cpt.InvestmentRecord.Builder clearInvestmentId() {
    ...
    public InvestmentRecord build() {
      try {
        ...
        record.investmentId = fieldSetFlags()[6] ? this.investmentId : (java.lang.Long) defaultValue(fields()[6]);
        return record;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<InvestmentRecord>
    WRITER$ = (org.apache.avro.io.DatumWriter<InvestmentRecord>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<InvestmentRecord>
    READER$ = (org.apache.avro.io.DatumReader<InvestmentRecord>)MODEL$.createDatumReader(SCHEMA$);
    ...
    throws java.io.IOException
  {
    ...
    out.writeLong(this.investmentId);
